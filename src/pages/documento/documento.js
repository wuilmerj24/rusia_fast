...
var DocumentoPage = /** @class */ (function () {
    function DocumentoPage(filePicker, plt, file, viewCtrl, base64, filePath, fileChooser, navCtrl, navParams) {
    ...
    DocumentoPage.prototype.guardar = function () {
        ...
        campos = {
            ...
            ciudades: [0, false, self.doc.ciudades],
    ...
    DocumentoPage = __decorate([
        ...
        __metadata("design:paramtypes", [IOSFilePicker, Platform, File, ViewController, Base64, FilePath, FileChooser, NavController, NavParams])
    ], DocumentoPage);
